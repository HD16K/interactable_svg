...
/// A class used to define the gesture detector data of the [InteractiveSVGWidget].
/// It is a copy of [GestureDetector] properties.
class GestureDetectorData {
 ...
 const factory GestureDetectorData.empty() = GestureDetectorData._empty;
  /// A constant constructor to use when no callbacks are specified.
  /// You should not need to use this constructor.
  const GestureDetectorData._empty({
    this.onTapDown,
    this.onTapUp,
    this.onTapCancel,
    this.onSecondaryTap,
  ...
  /// A standard constructor for [GestureDetectorData].
  GestureDetectorData({
    this.onTapDown,
    this.onTapUp,
    this.onTapCancel,
  ...
  /// Creates a [GestureDetector] with the given recognizers.
  /// You should not use this function
  GestureDetector build({required Widget child, required void Function() onTap}) {
    return GestureDetector(
      ...
      onTertiaryLongPressEnd: onSecondaryLongPressEnd,
